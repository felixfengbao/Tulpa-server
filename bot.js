...
var commands = {
    ...
    whois: (function () {
        var reply = [
            ...
            "Una persona cúl",
            "Una persona Kawaii",
            "Olvidalo, es virgen y la +ka",
            "Un Líder",
            "Es la estrella adamwest!!",
            "Que? Donde está?... *Se esconde bajo la cama*",
            "Alguien muy, pero muy arenoso :(",
            "Un Seguidor muy leal a Slayer",
            "MMM a veces juega bien, a veces es un nub",
        ];
        ...
        return function (target, room, user) {
            ...
            if (target === 'Fagenaux Ojara') message = 'Administrador de este server, actualmente uno de los jugadores mas experimentados que he conocido; líder indiscutible del clan Sword Black';
            if (target === config.userid()) message = 'Ese Soy YO! soy mucho mejor que los admins, no les digas porque se pondran arenosos >w< PD: Fage la +ka';
    ...
    helix: (function () {
        var reply = [
            ...
            "Ay nub, como gosas 7u7",
            "Las dos cosas ~",
            "Fuchila!!",
            "Soy la caracola magica :D",
            "No",
            "Si",
            "Pregunta de nuevo cariño :3",
            "No ewe",
            "Porque no te vas un poquito a la #!=/$ <3",
            "Pauli es linda x3",
            "No se lo digas a nadie, pero charly le hizo un baile sexual para tener leader owo",
            "DONDE?!!",
            "Ja, siempre caigo en esa XD",
            "tienes 3DS",
            "Slayer hazme un hijo",
            "Yo tambien te amo x3",
            "Saedua es experto en eso, y en sexo",
            "No avienten porqueria.",
            "Cuanto PD quieres para que cierres la boca? -w-"
        ];
